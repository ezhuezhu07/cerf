...
class L10nUk extends L10n {
  ...
  String acceptedTheInvitation(Object username) {
    return '${username} прийняв(ла) запрошення увійти в чат';
  }
  ...
  String activatedEndToEndEncryption(Object username) {
    return '${username} активував(ла) наскрізне шифрування';
  }
  ...
  String answeredTheCall(Object senderName) {
    return '${senderName} відповів(ла) на дзвінок';
  }
  ...
  @override
  String get askSSSSCache => 'Будь ласка, введіть вашу парольну фразу або ключ відновлення для кешування ключів.';

  @override
  String get askSSSSSign => 'Для підпису ключа іншого користувача, будь ласка, введіть вашу парольну фразу або ключ відновлення.';

  @override
  String get askSSSSVerify => 'Будь ласка, введіть вашу парольну фразу або ключ відновлення для підтвердження сесії.';
  ...
  @override
  String get avatarHasBeenChanged => 'Аватар був змінений';

  @override
  String get banFromChat => 'Заблокувати в чаті';

  @override
  String get banned => 'Заблокований(на)';

  @override
  String bannedUser(Object username, Object targetName) {
    return '${username} заблокував(ла) ${targetName}';
  }
  ...
  @override
  String get cachedKeys => 'Ключі було успішно збережено в кеші';
  ...
  String changedTheChatAvatar(Object username) {
    return '${username} змінив(ла) аватар чату';
  }

  @override
  String changedTheChatNameTo(Object username, Object chatname) {
    return '${username} змінив(ла) ім\'я чату на: \"${chatname}\"';
  }

  @override
  String changedTheChatDescriptionTo(Object username, Object description) {
    return '${username} змінив(ла) опис чату на: \"${description}\"';
  }

  @override
  String changedTheChatPermissions(Object username) {
    return '${username} змінив(ла) права доступу чату';
  }

  @override
  String changedTheDisplaynameTo(Object username, Object displayname) {
    return '${username} змінив(ла) відображуване ім\'я на: ${displayname}';
  }

  @override
  String get changeTheHomeserver => 'Змінити сервер Matrix';

  @override
  String changedTheGuestAccessRules(Object username) {
    return '${username} змінив(ла) правила гостьового доступу';
  }

  @override
  String changedTheGuestAccessRulesTo(Object username, Object rules) {
    return '${username} змінив(ла) правила гостьового доступу на: ${rules}';
  }

  @override
  String changedTheHistoryVisibility(Object username) {
    return '${username} змінив(ла) видимість історії';
  }

  @override
  String changedTheHistoryVisibilityTo(Object username, Object rules) {
    return '${username} змінив(ла) видимість історії на: ${rules}';
  }

  @override
  String changedTheJoinRules(Object username) {
    return '${username} змінив(ла) правила щодо приєднання';
  }

  @override
  String changedTheJoinRulesTo(Object username, Object joinRules) {
    return '${username} змінив(ла) правила щодо приєднання на: ${joinRules}';
  }

  @override
  String changedTheProfileAvatar(Object username) {
    return '${username} змінив(ла) аватар';
  }

  @override
  String changedTheRoomAliases(Object username) {
    return '${username} змінив(ла) псевдоніми кімнати';
  }

  @override
  String changedTheRoomInvitationLink(Object username) {
    return '${username} змінив(ла) посилання для запрошення';
  }
  ...
  @override
  String get changeWallpaper => 'Змінити фон чатів';
  ...
  @override
  String get compareEmojiMatch => 'Порівняйте і переконайтесь, що наступні емодзі відповідають емодзі на іншому пристрої:';

  @override
  String get compareNumbersMatch => 'Порівняйте і переконайтесь, що наступні числа відповідають числам на іншому пристрої:';

  @override
  String get confirm => 'Підтвердити';

  @override
  String get connect => 'Приєднатись';

  @override
  String get connectionAttemptFailed => 'Спроба підключення не вдалась';

  @override
  String get contactHasBeenInvitedToTheGroup => 'Контакт був запрошений в групу';

  @override
  String get contentViewer => 'Перегляд вмісту';
  ...
  String couldNotDecryptMessage(Object error) {
    return 'Помилка при розшифруванні повідомлення: ${error}';
  }

  @override
  String get couldNotSetAvatar => 'Помилка при встановленні аватара';

  @override
  String get couldNotSetDisplayname => 'Помилка при встановленні відображуваного імені';

  @override
  String countParticipants(Object count) {
    return '${count} учасника(ів)';
  }
  ...
  String createdTheChat(Object username) {
    return '${username} створив(ла) чат';
  }

  @override
  String get createNewGroup => 'Нова група';

  @override
  String get crossSigningDisabled => 'Крос-підпис вимкнено';

  @override
  String get crossSigningEnabled => 'Крос-підпис ввімкнено';

  @override
  String get currentlyActive => 'Зараз активний(на)';
  ...
  @override
  String get displaynameHasBeenChanged => 'Відображуване ім\'я було змінено';

  @override
  String get downloadFile => 'Завантажити файл';

  @override
  String get editDisplayname => 'Змінити відображуване ім\'я';
  ...
  @override
  String get emoteWarnNeedToPick => 'Виберіть короткий код емодзі і зображення';
  ...
  @override
  String get emptyChat => 'Пустий чат';
  ...
  @override
  String get enableEncryptionWarning => 'Ви більше не зможете відключити шифрування. Ви впевнені?';
  ...
  String endedTheCall(Object senderName) {
    return '${senderName} завершив(ла) дзвінок';
  }
  ...
  @override
  String get enterYourHomeserver => 'Введіть адресу вашого сервера Matrix';
  ...
  @override
  String get groupIsPublic => 'Публічна група';
  ...
  String hasWithdrawnTheInvitationFor(Object username, Object targetName) {
    return '${username} відкликав(ла) запрошення для ${targetName}';
  }
  ...
  String kickedAndBanned(Object username, Object targetName) {
    return '${username} виключив(ла) та заблокував(ла) ${targetName}';
  }
  ...
  String unbannedUser(Object username, Object targetName) {
    return '${username} розблокував(ла) ${targetName}';
  }
  ...
  @override
  String get youHaveBeenBannedFromThisChat => 'Ви були заблоковані в цьому чаті';
