...
abstract class AppConfig {
  ...
  static String jitsiInstance = 'https://vannevar-meet.phyos.live/';
  static double fontSizeFactor = 1.0;
  static const bool allowOtherHomeservers = true;
  static const bool enableRegistration = true;
  static const Color primaryColor = Color(0xFFc8ff00);
  static const Color primaryColorLight = Color(0xFFE1FF7B);
