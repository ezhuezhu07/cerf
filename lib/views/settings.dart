        ...
        body: ListView(
          children: <Widget>[
            ...
            ListTile(
              ...
              trailing: Icon(Icons.style_outlined, color: Colors.black),
            ),
            ...
            ListTile(
              ...
              trailing: Icon(Icons.archive_outlined, color: Colors.black),
            ),
            Divider(thickness: 1),
            ListTile(
              title: Text(
            ...
            ListTile(
              trailing: Icon(Icons.block_outlined, color: Colors.black),
            ...
            // ),
            ListTile(
              trailing: Icon(Icons.exit_to_app_outlined, color: Colors.black),
