          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: TextField(
                ...
                maxLength: 25,
                decoration: InputDecoration(
                  // border: InputBorder(borderSide:BorderSide(color: Color(0xFF000000)),),

                  border: OutlineInputBorder(
                      borderSide: BorderSide(color: Colors.black, width: 3)),
                  prefixIcon:
                      Icon(Icons.lock_outlined, color: Color(0xFF000000)),
                  hintText: '****',
                  ...
                  focusedBorder: OutlineInputBorder(
                    borderSide: BorderSide(color: Color(0xFF5d7700)),
                  ),
                ),
                style: TextStyle(
                  fontFamily: 'OpenSans',
